...
public:
	...
	explicit AckRange(const PacketSequenceNumber inStart) : mStart(inStart), mCount(1)
	{
	}
...
inline bool AckRange::ExtendIfShould(const PacketSequenceNumber inSequenceNumber)
{

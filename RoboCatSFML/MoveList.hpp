...
{
public:
	using const_iterator = deque<Move>::const_iterator;
	using const_reverse_iterator = deque<Move>::const_reverse_iterator;
	...
	const Move& operator[](const size_t i) const { return mMoves[i]; }
private:
